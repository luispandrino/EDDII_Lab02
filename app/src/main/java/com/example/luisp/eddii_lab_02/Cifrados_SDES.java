...
public class Cifrados_SDES extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cifrados__sdes);
        ...
        btnInit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(key.contains("2") || key.contains("3") || key.contains("4") || key.contains("5") || key.contains("6") || key.contains("7") || key.contains("8") || key.contains("9") )  {
                    Error();
                }else{
                    if(rbEnc.isChecked()){
...
// Here, thisActivity is the current activity
        if (ContextCompat.checkSelfPermission(Cifrados_SDES.this,
                Manifest.permission.READ_CONTACTS)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(Cifrados_SDES.this,
                    Manifest.permission.READ_CONTACTS)) {
                ...
                ActivityCompat.requestPermissions(Cifrados_SDES.this,
